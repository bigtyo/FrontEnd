...
<body class="home page page-template">
    ...
    <div id="content" class="clearfix">
        ...
        <div id="frontpage-slider-wrapper" class="revolution-slider fullwidthbanner-container" style="margin:0px auto;background-color:#E9E9E9;padding:0px;margin-top:0px;margin-bottom:0px;max-height:700px;">
            <div id="frontpage-slider" class="rev_slider fullwidthabanner" style="display:none;max-height:700px;height:700;">
                <ul>
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                        <img src="<?php echo base_url()?>template/assets/img/revolution/bg1.jpg" alt="bg3" data-fullwidthcentering="on">

                        <div class="tp-caption very_large_text sfr" data-x="10" data-y="266" data-speed="300" data-start="500" data-easing="easeInOutQuad">Situs Property Paling Lengkap:
                        </div>

                        <div class="tp-caption large_text sfr" data-x="10" data-y="369" data-speed="300" data-start="600" data-easing="easeInOutQuad">Listing paling update
                        </div>

                        <div class="tp-caption large_text sfr" data-x="9" data-y="422" data-speed="300" data-start="700" data-easing="easeInOutQuad">Harga Kompetitif
                        </div>

                        <div class="tp-caption large_text sfr" data-x="10" data-y="477" data-speed="300" data-start="800" data-easing="easeInOutQuad">Agent Terbaik
                        </div>

                        <div class="tp-caption large_text sfr" data-x="10" data-y="528" data-speed="300" data-start="1100" data-easing="easeInOutQuad">Lebih banyak pilihanya
                        </div>
            ...
            <div class="row">
                ...
                <div id="main" class="span9">
                    ...
                    <div class="properties-grid">
                        <div class="row-fluid">
                            <?php foreach($this->rumahsuper->homepage_project() as $property){ ?>
                            <div class="span3">
                                <div class="property">
                                    <div class="image">
                                        <div class="content">
                                            <a href="<?php echo base_url()."detail-".url_title(strtolower($property->JUDUL)."- ".$property->LISTINGID); ?>">
					...
					<?php 
						$array_count = array(0,4,8,12,16,20,24,28);
						foreach($array_count as $count) {
					?>
					<div class="properties-grid">
                        <div class="row-fluid">
                            <?php foreach($this->rumahsuper->homepage_listing($count) as $property){ ?>
                            <div class="span3">
                                <div class="property">
                                    <div class="image">
                                        <div class="content">
