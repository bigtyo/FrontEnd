                ...
                <div class="location control-group">
                    ...
                    <div class="controls">
                        <select name="kota">
                            ...
                            <option value="<?php echo $item->NAMA_TIPE ?>">
                                <?php echo $item->NAMA_TIPE ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <!-- /.controls -->
                ...
                <div class="type control-group">
                    ...
                    <div class="controls">
                        <select name="area">
                            ...
                            <option value="<?php echo $item->AREAID ?>">
                                <?php echo $item->NAMA_AREA ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <!-- /.controls -->
                ...
                <div class="type control-group">
                    ...
                    <div class="controls">
                        <select name="kota">
                            ...
                            <option value="<?php echo $kota->KOTAID ?>">
                                <?php echo $kota->NAMA_KOTA ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <!-- /.controls -->
                ...
                <div class="type control-group">
                    ...
                    <div class="controls">
                        <select name="propinsi">
                            ...
                            <option value="<?php echo $item->PROPINSIID ?>">
                                <?php echo $item->NAMA_PROPINSI ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <!-- /.controls -->
                ...
                <div class="type control-group">
                    ...
                    <div class="controls">
                        <select name="filter_type">
                            ...
                            <option value="1">
                                < Rp 250 juta</option>
                                    <option value="2">Rp 250 juta - Rp 500 juta</option>
                                    <option value="3">Rp 500 juta - Rp 1 miliar</option>
                                    <option value="4">Rp 1 miliar - Rp 2 miliar</option>
                                    <option value="5">Rp 2 miliar - Rp 5 miliar</option>
                                    <option value="6">> Rp 5 miliar</option>
                        </select>
                    </div>
                    <!-- /.controls -->
                </div>
