			...
			<div class="container">
				<ul class="breadcrumb">
					<li><a href="<?php echo base_url()?>">Home</a> <span class="divider">/</span></li>
				  	<li><a href="<?php echo base_url("project")?>">Event</a> <span class="divider">/</span></li>
				  	<li class="active"><?php echo $project->JUDUL ?></li>
				</ul>
				...
				<div class="row">
					...
					<div id="main" class="span12 single-property">
						<h1 class="page-header fl"><?php echo $project->JUDUL ?></h1>
                                                
						<div class="property-detail">
                                                    <div class="span12 gallery">
                                                        <div class="preview">
                                                                <img src="<?php echo EVENT_UPLOAD_PATH.$project->GAMBAR; ?>" alt="">
                                                        </div>
										...
										<div class="span6">
											...
											<div class="row">
												<ul class="span6">
													...
													<li class="checked">Tempat : <?php echo $event->ALAMAT ?></li>
													<li class="checked">Tanggal Update : <?php echo $event->tanggal ?></li>
