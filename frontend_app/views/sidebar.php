<div class="sidebar span3">
                ...
                <div class="location control-group">
                    ...
                    <div class="controls">
                        <select name="kota" id="tipepropertiid">
                            ...
                            <option value="<?php echo $item->TIPEPROPID; ?>">
    ...
    <div id="mostrecentproperties_widget-2" class="widget properties">
        ...
        <div class="content">
            ...
            <?php if(isset($recents)){ foreach ($recents as $obj) { ?>
            <div class="property clearfix">
                <div class="image">
                    <a href="<?php echo base_url()." property/ ".url_title(strtolower($obj->JUDUL))."- ".$obj->LISTINGID ?>">
                        <img width="570" height="425" src="<?php echo NODE_URL; ?>getimagelisting?id=<?php echo $obj->LISTINGID; ?>" class="thumbnail-image " alt="17" />
                    </a>
                </div>
                <!-- /.image -->
