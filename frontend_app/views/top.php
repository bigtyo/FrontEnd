...
<!--							<li class="menu-item"><a href="<?php echo base_url()?>main/single">Property Detail</a></li>-->
				...
				<div class="pull-right">
					<div class="list-property">
						<a href="<?php echo base_url()?>subscribe">Subscribe Newsletter<div class="ribbon"><span style="margin-left: 12px" class="icon icon-envelope icon-white"></span></div>
						</a>
					</div>
					<!-- /.list-property -->
				</div>
